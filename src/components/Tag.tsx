...
const Tag: React.FC<TagProps> = ({ tag }) => {
  ...
  const colorClasses: ColorClass = {
    // lookup of color classes for purgecss per https://github.com/tailwindlabs/tailwindcss/discussions/3461
    red: "bg-red-500",
    blue: "bg-blue-500",
    green: "bg-green-500",
  ...
  return (
    <div
      className={`flex h-5 flex-row items-center justify-center space-x-2 rounded-xl p-2 ${
