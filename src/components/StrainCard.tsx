...
const StrainCard: React.FC<Props> = (props) => (
    <Link href={`/strain/${props.strain.id}`}>
        <div className="card flex w-96 md:w-72 min-h-96 flex-col overflow-hidden bg-base-100 shadow-lg shadow-gray-100/5 transition-all hover:-translate-y-2 hover:bg-secondary">
            {props.strain.image && (
                <Image
            ...
            <div className="badge badge-primary absolute right-3 top-3 uppercase text-white font-bold h-auto p-1 text-sm">{
